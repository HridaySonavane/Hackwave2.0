      ...
      if (currentQuestion && currentQuestionIndex >= 0) {
        ...
        try {
          ...
          if (!continueData.content) {
            console.error("Content is undefined in continue response");
            setDebugInfo("Content is undefined in continue response");
            throw new Error(
              "Invalid response from server: content is undefined"
            );
          }
