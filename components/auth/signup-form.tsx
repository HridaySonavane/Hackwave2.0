...
export function SignUpForm() {
  ...
  if (step === "otp") {
    return <OTPForm email={formData.email} onBack={handleBackToSignup} onSuccess={handleOTPSuccess} />
  }
    ...
    return (
      <Card className="border-0 shadow-lg">
        <CardContent className="p-8 text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-2">Welcome to ResumeAI!</h3>
          <p className="text-gray-600 mb-8">
            Your account has been created successfully. You can now start building your professional resume with AI
            assistance.
          </p>
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 px-2 text-gray-500 dark:text-gray-400">
        ...
        <div className="text-center mb-8">
          ...
          <Link href="/auth/signin" className="text-blue-600 dark:text-blue-500 hover:underline font-medium">
            Sign in
          </Link>
        </div>
      </div>
